...
@section('gestion')
    <div class="p-6 w-full flex flex-col gap-7">
        <form action="/tag/{{ $tag->id }}" class="relative h-11 w-full min-w-[200px]" method="POST">
            @csrf
            ...
            disabled:border-0 disabled:bg-blue-gray-50" placeholder=" " name="nombre" value="{{ $tag->nombre }}">
