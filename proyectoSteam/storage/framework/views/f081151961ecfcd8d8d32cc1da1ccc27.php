...
<?php $__env->startSection('gestion'); ?>
    <div class="p-6 w-full flex flex-col gap-7">
        ...
        <form action="/plataforma/<?php echo e($plataforma->id); ?>" class="relative h-11 w-full min-w-[200px]" method="POST">
            <?php echo csrf_field(); ?>
            ...
            disabled:border-0 disabled:bg-blue-gray-50" placeholder=" " name="nombre" value="<?php echo e($plataforma->nombre); ?>">
...
<?php echo $__env->make('admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Xavier\Desktop\DAW2n\M07\laravel\steam\resources\views/editarPlataformas.blade.php ENDPATH**/ ?>