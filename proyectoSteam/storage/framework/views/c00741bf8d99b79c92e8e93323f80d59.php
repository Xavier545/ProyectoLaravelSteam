<aside class="w-50 bg-[#0b111f] min-h-full h-screen flex flex-col items-center pt-5 pb-2 space-y-7">
    ...
    <div class="w-full pr-3 flex flex-col gap-y-1 text-gray-500 fill-gray-500 text-sm">
        ...
        <a class="w-full flex items-center gap-x-1.5 group select-none" href="#">
            ...
            <div class="group group-hover:bg-white/10 w-full group-active:scale-95 self-stretch pl-2 rounded flex items-center space-x-2 transition-all duration-200 dark:group-hover:text-white dark:hover:text-blue text-sm" href="#">
                <svg class="h-5 w-5 transition-colors duration-200 stroke-current text-gray-500 group-hover:text-blue-600" 
        ...
        <a class="w-full flex items-center gap-x-1.5 group select-none" href="#">
            ...
            <div class="group group-hover:bg-white/10 w-full group-active:scale-95 self-stretch pl-2 rounded flex items-center space-x-2 transition-all duration-200 dark:group-hover:text-white dark:hover:text-blue text-sm" href="#">
                <svg class="h-5 w-5 transition-colors duration-200 stroke-current text-gray-500 group-hover:text-blue-600" xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24">
        ...
        <a class="w-full flex items-center gap-x-1.5 group select-none" href="/tags">
            <div class="w-1 rounded-xl h-8 bg-transparent transition-colors duration-200 relative overflow-hidden">
                <div class="<?php echo e(request()->routeIs('tags.index') ? 'w-1 rounded-xl h-8 bg-transparent transition-colors duration-200 relative overflow-hidden' : 'text-green-700 translate-y-full h-[102%] group-hover:translate-y-0'); ?> absolute top-0 left-0 w-full bg-blue-600 transition-all duration-300"></div>
            </div>
            <div class="<?php echo e(request()->routeIs('tags.index') ? 'bg-white/10' : 'group-hover:bg-white/10'); ?> group w-full group-active:scale-95 self-stretch pl-2 rounded flex items-center space-x-2 transition-all duration-200 dark:group-hover:text-white dark:hover:text-blue text-sm" href="#">
                <svg class="h-5 w-5 transition-colors duration-200 stroke-current text-gray-500 group-hover:text-blue-600" xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24" width="512" height="512">
        ...
        <a class="w-full flex items-center gap-x-1.5 group select-none" href="#">
            ...
            <div class="group group-hover:bg-white/10 w-full group-active:scale-95 self-stretch pl-2 rounded flex items-center space-x-2 transition-all duration-200 dark:group-hover:text-white dark:hover:text-blue text-sm" href="#">
                <svg class="h-5 w-5 transition-colors duration-200 stroke-current text-gray-500 group-hover:text-blue-600" xmlns="http://www.w3.org/2000/svg" id="Outline" viewBox="0 0 24 24" width="512" height="512">
        ...
        <a class="w-full flex items-center gap-x-1.5 group select-none" href="#">
            ...
            <div class="group group-hover:bg-white/10 w-full group-active:scale-95 self-stretch pl-2 rounded flex items-center space-x-2 transition-all duration-200 dark:group-hover:text-white dark:hover:text-blue text-sm" href="#">
                <svg class="h-5 w-5 transition-colors duration-200 stroke-current text-gray-500 group-hover:text-blue-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
...
</aside><?php /**PATH C:\Users\Xavier\Desktop\DAW2n\M07\laravel\steam\resources\views\partials\sidebar.blade.php ENDPATH**/ ?>