    ...
    <div class="flex items-center space-x-3">
        ...
        <?php else: ?>
            ...
            <div class="flex items-center space-x-4 px-4 rounded-lg">
                <a class="hidden sm:inline hover:underline hover:text-blue-500 cursor-pointer" href="/profile"><?php echo e(Auth::user()->name); ?></a>
                <img src="<?php echo e(asset('img/UserIcon.png')); ?>" alt="UserImg" class="w-10 h-10 rounded-full border-1 border-black">
            </div>
        <?php endif; ?>
    </div>
</nav><?php /**PATH C:\Users\Xavier\Desktop\DAW2n\M07\laravel\steam\proyectoSteam\resources\views/components/navbar.blade.php ENDPATH**/ ?>