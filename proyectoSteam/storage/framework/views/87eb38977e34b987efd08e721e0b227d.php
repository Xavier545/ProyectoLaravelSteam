...
<?php $__env->startSection('gestion'); ?>
    <div class="p-6 w-full flex flex-col gap-7">
        ...
        <table class="w-full border-2 border-gray-800">
            ...
            <tbody>
                <?php $__currentLoopData = $todasLasPlataformas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plataforma): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="bg-white/3 text-white border-b border-gray-700">
                        <td class="p-2"><?php echo e($plataforma->id); ?></td>
                        <td class="p-2"><?php echo e($plataforma->nombre); ?></td>
                        <td class="p-2 flex gap-4">
                            <form action="/plataforma/<?php echo e($plataforma->id); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                            ...
                            <form action="/plataforma/<?php echo e($plataforma->id); ?>" method="GET">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Xavier\Desktop\DAW2n\M07\laravel\steam\resources\views/gestionPlataformas.blade.php ENDPATH**/ ?>