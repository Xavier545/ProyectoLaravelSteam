...
<html>
    ...
    <body class="bg-[#0e1626] h-screen flex flex-col relative justify-center items-center">
        <div class="flex relative">
            <form action="#" class="flex flex-col gap-5 items-center text-white relative h-full w-full min-w-[200px] border-4 p-10 border-slate-700 rounded-xl bg-white/4" method="POST">
                <?php echo csrf_field(); ?>
                <h1 class="text-white text-4xl">Iniciar Sesion</h1>
                ...
                <input type="submit" value="Iniciar Sesion" class="h-10 w-25 bg-blue-600 text-white rounded
                transition-all duration-100 hover:bg-blue-700 hover:scale-95 active:scale-90 cursor-pointer">

                <div class="text-gray-600 h-10 w-50 text-center text-sm">Si no tienes una cuenta 
                    <a href="/register" class="text-blue-500">Registrate</a>
                     ahora!
                </div>
            </form>
        </div>
    </body>
</html><?php /**PATH C:\Users\Xavier\Desktop\DAW2n\M07\laravel\steam\resources\views/login.blade.php ENDPATH**/ ?>