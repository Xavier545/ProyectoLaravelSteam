<?php $__env->startSection('gestion'); ?>
    <div class="p-6 w-full flex flex-col gap-7">
        ...
        <form action="/idioma" class="relative h-11 w-full min-w-[200px]" method="POST">
            <?php echo csrf_field(); ?>
        ...
        <table class="w-full border-2 border-gray-800">
            ...
            <tbody>
                <?php $__currentLoopData = $todosLosIdiomas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idioma): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="bg-white/3 text-white border-b border-gray-700">
                        <td class="p-2"><?php echo e($idioma->id); ?></td>
                        <td class="p-2"><?php echo e($idioma->nombre); ?></td>
                        <td class="p-2 flex gap-4">
                            <form action="/idioma/<?php echo e($idioma->id); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                            ...
                            <form action="/idioma/<?php echo e($idioma->id); ?>" method="GET">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Xavier\Desktop\DAW2n\M07\laravel\steam\resources\views/gestionIdiomas.blade.php ENDPATH**/ ?>