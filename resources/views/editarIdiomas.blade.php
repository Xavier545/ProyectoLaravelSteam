...
@section('gestion')
    <div class="p-6 w-full flex flex-col gap-7">
        ...
        <form action="/idioma/{{ $idioma->id }}" class="relative h-11 w-full min-w-[200px]" method="POST">
            @csrf
            ...
            disabled:border-0 disabled:bg-blue-gray-50" placeholder=" " name="nombre" value="{{ $idioma->nombre }}">
